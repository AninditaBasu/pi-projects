...
1.  Connect `rclone` to your cloud store:
	...
	1.  Return to your laptop, open the command prompt, and go to the folder where you extracted `rclone` to. Paste the command that you copied from Raspberry Pi. You're given a verification code. ![rclone](../images/rclone_verif_code.png")
